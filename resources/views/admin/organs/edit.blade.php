    ...
    <div class="col-12 bg-white p-0">
        ...
        <div class="block">
            <div class="block-header block-header-default">
                <h3 class="block-title">{{ __('categories.organs') }}: {{ $organization->id }}</h3>
            </div>
            <div class="block-content">
                <form action="{{ route('organization.update', ['organization' => $organization->id]) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="title" name="title" placeholder="{{ __('dashboard.enter_title') }}" value="{{ $organization->title }}" required>
                        @error('title')
